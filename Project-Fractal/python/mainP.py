...
teamsDF.info
matchesTeamsDF=pd.read_csv('C://Users//Mayank//Desktop//Project-Fractal//Gen1//match_team2.csv')
matchesTeamsDF.info()
...
def predict():
    ...
    day=input()
    px = d.generatePredictData(int(teamId),int(opponentId),int(tossWon),int(batFirst), int (day))
    print(d.generatePredictData)
    px
