...
def generatePredictData(teamId,opponentId,tossWon,batFirst,day):    
    data = pd.DataFrame(columns=('Match_Id','Team_Id','Day','Toss_Won','Bat_First','Win_Percenetage','Opponent_Win_Percentage','Win_Percenetage_Against','Toss_Decision_Win_Percentage','Bat_Decision_Win_Percentage','Team1_Score','OpponentId_Score','Match_Won'))
    pos = 0
    matchId = 1
   # venue=100
    teamTossWon = 0
